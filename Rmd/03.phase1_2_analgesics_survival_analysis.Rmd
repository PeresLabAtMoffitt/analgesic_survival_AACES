---
title: "Association of analgesic medication use with survival among Black women with ovarian cancer-phase1 and 2"
...
analgesics <-
  read_rds(paste0(here::here(), "/Cleaned imputed analgesics medication data_phase1_2_04032024.rds")) %>% 
...
var_label(analgesics) <- list(refage = "Patient age", 
                         ...
                         stren_mins_per_wk = "Strenuous physical activity (Number of minutes/week)",
                         mod_mins_per_wk = "Moderate physical activity (Number of minutes/week)",
...
#          paga, imp_paga,
#          stren_mins_per_wk, mod_mins_per_wk) %>% 
...
analgesics %>% 
  ...
  add_p() %>% bold_p(t = 0.05) %>% 
  add_overall() %>%
  modify_spanning_header(c("stat_1", "stat_2") ~ "**AACES phase**")
```
