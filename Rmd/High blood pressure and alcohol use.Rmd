---
title: "High blood pressure and alcohol use"
...
analgesics <-
  read_rds(paste0(here::here(), "/data 02062025.rds"))
```
...
<!-- #            ), -->
<!-- #   category.names = c("aceta", -->
<!-- #                      "nsaid", -->
<!-- #                      "aspirin" -->
<!-- #                      ), -->
<!-- #   filename = 'vennd_drugs.png', -->
<!-- #   output=TRUE, -->
...
<!-- #   fontfamily = "sans", -->
<!-- #   # cat.pos = c(-90, 0, 90), #  -->
<!-- #   # cat.dist = c(0.2, 0.28, 0.22, 0.24, 0.36),  -->
<!-- #   # ext.percent = 2 -->
<!-- #   #ext.percent = 5 -->
<!-- # ) -->
<!-- # ``` -->
...
```{r}
analgesics %>% 
  select(contains("drink"), contains("wine"), contains("beer"), contains("liquor"),
         contains("hbp")
         ) %>% 
